...
class Home_page_wrapper extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamProvider<UserData>.value(
      ...
      initialData: UserData(level: 1,name: "Bob",uid: "PP",experiences: 10,friendIDs: List.empty(),friendIDRequests: List.empty(),friendNames: List.empty(),friendNameRequests: List.empty(),friendExps: List.empty(),friendExpRequests: List.empty()),
